...
window.addEventListener('resize', function () {
    var img = document.querySelectorAll('#carouselExampleCaptions .carousel-item img');
    var height = window.innerHeight;
    for (var i = 0; i < img.length; i++) {
      var width = img[i].naturalWidth;
      var ratio = height / img[i].naturalHeight;
      img[i].style.height = height + 'px';
      img[i].style.width = width * ratio + 'px';
    }
  });
